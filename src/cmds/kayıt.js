...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if(await client.permission(message.author.id, "register")) {
            ...
            const newDisplayName = `${member.user.username.includes(config.Tag) ? config.Tag : config.SecondaryTag} ${Name}`;
            ...
            if(!data) {
                ...
                noDataCollector.on("collect", async (button) => {
                    ...
                    if(button.id === "manButton") {
                        ...
                        message.react(settings.emojis.onay)
